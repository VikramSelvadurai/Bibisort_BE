package com.example.bigbisort_be.common.MapBuilder;
...
public class MapBuilder<X, Y>{
     ...
     * @return Map<X, Y> with given key-value added
     */
    public static <X, Y> Map<X, Y> of(X key1, Y value1, X key2, Y value2, X key3, Y value3) {
        Map<X, Y> map = new HashMap<>(3);
        map.put(key1, value1);
        map.put(key2, value2);
        map.put(key3, value3);
        return map;
